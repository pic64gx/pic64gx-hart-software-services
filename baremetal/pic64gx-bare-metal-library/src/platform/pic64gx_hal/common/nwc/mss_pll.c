...
void set_RTC_divisor(void)
{
    ...
    SYSREG->RTC_CLOCK_CR = (BSP_SETTING_MSS_EXT_SGMII_REF_CLK / \
            BSP_SETTING_MSS_RTC_TOGGLE_CLK);
...
static void mss_mux_pre_mss_pll_config(void)
{
    ...
    MSS_SCB_CFM_MSS_MUX->PLL_CKMUX = BSP_SETTING_MSS_PLL_CKMUX;
    /*
     ...
     * clock
     * MSS_SCB_CFM_MSS_MUX->MSSCLKMUX           = BSP_SETTING_MSS_MSSCLKMUX;
     */
     ...
     *  [0]     en_udrive_p
     */
    MSS_SCB_CFM_SGMII_MUX->CLK_XCVR         = BSP_SETTING_SGMII_CLK_XCVR;
     ...
     *
     */
    MSS_SCB_CFM_MSS_MUX->BCLKMUX        =   BSP_SETTING_MSS_BCLKMUX;

    /*  MSS_SCB_CFM_MSS_MUX->SPARE0         =   BCLKMUX_USER_CONFIG;       */
    MSS_SCB_CFM_MSS_MUX->FMETER_ADDR    =   BSP_SETTING_MSS_FMETER_ADDR;

    MSS_SCB_CFM_MSS_MUX->FMETER_DATAW   =   BSP_SETTING_MSS_FMETER_DATAW;

    MSS_SCB_CFM_MSS_MUX->FMETER_DATAR   =   BSP_SETTING_MSS_FMETER_DATAR;
        ...
        static void mss_mux_post_mss_pll_config(void)
{
    ...
    *
    */
    SYSREG->ENVM_CR = BSP_SETTING_MSS_ENVM_CR;
   ...
   */
  SYSREG->CLOCK_CONFIG_CR = BSP_SETTING_MSS_CLOCK_CONFIG_CR;
...
{
    uint32_t pclk_freq;
    uint32_t scale = BSP_SETTING_MSS_CLOCK_CONFIG_CR & (0x3UL<<4U);
    uint32_t current_scale = SYSREG->CLOCK_CONFIG_CR & (0x3UL<<4U);

    pclk_freq = BSP_SETTING_MSS_APB_AHB_CLK * (current_scale/scale);
...
{
    uint32_t axi_freq;
    uint32_t scale = BSP_SETTING_MSS_CLOCK_CONFIG_CR & (0x3UL<<2U);
    uint32_t current_scale = SYSREG->CLOCK_CONFIG_CR & (0x3UL<<2U);

    axi_freq = BSP_SETTING_MSS_AXI_CLK * (current_scale/scale);
...
{
    uint32_t mss_freq;
    uint32_t scale = BSP_SETTING_MSS_CLOCK_CONFIG_CR & (0x3UL<<0U);
    uint32_t current_scale = SYSREG->CLOCK_CONFIG_CR & (0x3UL<<0U);

    mss_freq = BSP_SETTING_MSS_SYSTEM_CLK * (current_scale/scale);
    ...
    switch(option)
    {
        ...
        case SCB_UPDATE:   /* write to   SCB register */
                ...
                MSS_SCB_CFM_SGMII_MUX->SGMII_CLKMUX =\
                    BSP_SETTING_SGMII_SGMII_CLKMUX;
                /*
                ...
                MSS_SCB_CFM_SGMII_MUX->CLK_XCVR =\
                        BSP_SETTING_SGMII_CLK_XCVR;   /* 0x2011 */
                /*
...
void mss_pll_config(void)
{
    ...
    */
    ...
    MSS_SCB_MSS_PLL->PLL_CTRL       = BSP_SETTING_MSS_PLL_CTRL & ~(PLL_CTRL_REG_POWERDOWN_B_MASK);

    /*
     * PLL calibration register
     * This value is factory set, do not overwrite
     * MSS_SCB_MSS_PLL->PLL_CAL        = BSP_SETTING_MSS_PLL_CAL;
     *
     */

    MSS_SCB_MSS_PLL->PLL_REF_FB     = BSP_SETTING_MSS_PLL_REF_FB;

    MSS_SCB_MSS_PLL->PLL_DIV_0_1    = BSP_SETTING_MSS_PLL_DIV_0_1;

    MSS_SCB_MSS_PLL->PLL_DIV_2_3    = BSP_SETTING_MSS_PLL_DIV_2_3;

    MSS_SCB_MSS_PLL->PLL_CTRL2      = BSP_SETTING_MSS_PLL_CTRL2;

    MSS_SCB_MSS_PLL->PLL_FRACN      = BSP_SETTING_MSS_PLL_FRACN;
    MSS_SCB_MSS_PLL->SSCG_REG_0     = BSP_SETTING_MSS_SSCG_REG_0;
    MSS_SCB_MSS_PLL->SSCG_REG_1     = BSP_SETTING_MSS_SSCG_REG_1;

    MSS_SCB_MSS_PLL->SSCG_REG_2     = BSP_SETTING_MSS_SSCG_REG_2;
    MSS_SCB_MSS_PLL->SSCG_REG_3     = BSP_SETTING_MSS_SSCG_REG_3;

    /* PLL phase registers */
    MSS_SCB_MSS_PLL->PLL_PHADJ      = BSP_SETTING_MSS_PLL_PHADJ;
    ...
    MSS_SCB_MSS_PLL->PLL_CTRL       = (BSP_SETTING_MSS_PLL_CTRL) | 0x01U;
    /*
     * Start up the PLL with NEW parameters.
     * Wait for LOCK
...
void ddr_pll_config(REG_LOAD_METHOD option)
{
    ...
    switch(option)
    {
        ...
        case SCB_UPDATE:   /* write to   SCB register */
            ...
            MSS_SCB_DDR_PLL->PLL_CTRL         = BSP_SETTING_DDR_PLL_CTRL & ~(PLL_CTRL_REG_POWERDOWN_B_MASK);
            /* PLL calibration register */

            /*
             * PLL calibration register
             * This value is factory set, do not overwrite
             * MSS_SCB_DDR_PLL->PLL_CAL        = BSP_SETTING_MSS_PLL_CAL;
             *
             */

            MSS_SCB_DDR_PLL->PLL_REF_FB    = BSP_SETTING_DDR_PLL_REF_FB;


            MSS_SCB_DDR_PLL->PLL_DIV_0_1   = BSP_SETTING_DDR_PLL_DIV_0_1;

            MSS_SCB_DDR_PLL->PLL_DIV_2_3   = BSP_SETTING_DDR_PLL_DIV_2_3;


            MSS_SCB_DDR_PLL->PLL_CTRL2     = BSP_SETTING_DDR_PLL_CTRL2;

            MSS_SCB_DDR_PLL->PLL_FRACN     = BSP_SETTING_DDR_PLL_FRACN;
            MSS_SCB_DDR_PLL->SSCG_REG_0    = BSP_SETTING_DDR_SSCG_REG_0;
            MSS_SCB_DDR_PLL->SSCG_REG_1    = BSP_SETTING_DDR_SSCG_REG_1;

            MSS_SCB_DDR_PLL->SSCG_REG_2    = BSP_SETTING_DDR_SSCG_REG_2;
            MSS_SCB_DDR_PLL->SSCG_REG_3    = BSP_SETTING_DDR_SSCG_REG_3;

            /* PLL phase registers */

            MSS_SCB_DDR_PLL->PLL_PHADJ     = BSP_SETTING_MSS_PLL_PHADJ;

            MSS_SCB_DDR_PLL->PLL_CTRL      = (BSP_SETTING_DDR_PLL_CTRL)\
...
void sgmii_pll_config_scb(uint8_t option)
{
    ...
    switch(option)
    {
        ...
        case SCB_UPDATE:   /* write to   SCB register */
            ...
            MSS_SCB_SGMII_PLL->PLL_CTRL      = BSP_SETTING_SGMII_PLL_CTRL & ~(PLL_CTRL_REG_POWERDOWN_B_MASK);
            /* PLL calibration register */

            /*
             * PLL calibration register
             * This value is factory set, do not overwrite
             * MSS_SCB_SGMII_PLL->PLL_CAL        = BSP_SETTING_MSS_PLL_CAL;
             *
             */

            MSS_SCB_SGMII_PLL->PLL_REF_FB    = BSP_SETTING_SGMII_PLL_REF_FB;


            MSS_SCB_SGMII_PLL->PLL_DIV_0_1   = BSP_SETTING_SGMII_PLL_DIV_0_1;

            MSS_SCB_SGMII_PLL->PLL_DIV_2_3   = BSP_SETTING_SGMII_PLL_DIV_2_3;


            MSS_SCB_SGMII_PLL->PLL_CTRL2     = BSP_SETTING_SGMII_PLL_CTRL2;

            MSS_SCB_SGMII_PLL->PLL_FRACN     = BSP_SETTING_SGMII_PLL_FRACN;
            MSS_SCB_SGMII_PLL->SSCG_REG_0    = BSP_SETTING_SGMII_SSCG_REG_0;
            MSS_SCB_SGMII_PLL->SSCG_REG_1    = BSP_SETTING_SGMII_SSCG_REG_1;

            MSS_SCB_SGMII_PLL->SSCG_REG_2    = BSP_SETTING_SGMII_SSCG_REG_2;
            MSS_SCB_SGMII_PLL->SSCG_REG_3    = BSP_SETTING_SGMII_SSCG_REG_3;

            /* PLL phase registers */

            MSS_SCB_SGMII_PLL->PLL_PHADJ     = BSP_SETTING_SGMII_PLL_PHADJ;

            MSS_SCB_SGMII_PLL->PLL_CTRL      = (BSP_SETTING_SGMII_PLL_CTRL)\
                    | 0x01U;  /* bit 0 == REG_POWERDOWN_B */
