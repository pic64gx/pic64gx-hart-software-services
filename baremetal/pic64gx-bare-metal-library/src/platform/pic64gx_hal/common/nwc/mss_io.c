...
#ifdef BSP_SETTING_ALT_IOMUX1_CR
#if ((BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS & (EMMC_CONFIGURED_MASK | SD_CONFIGURED_MASK)) == (EMMC_CONFIGURED_MASK | SD_CONFIGURED_MASK))
...
IOMUX_CONFIG   iomux_config_values = {
    BSP_SETTING_IOMUX0_CR, /* Selects whether the peripheral is connected to
                                 the Fabric or IOMUX structure. */
    BSP_SETTING_IOMUX1_CR, /* BNK4 SDV PAD 0 to 7, each IO has 4 bits   */
    BSP_SETTING_IOMUX2_CR, /* BNK4 SDV PAD 8 to 13     */
    BSP_SETTING_IOMUX3_CR, /* BNK2 SDV PAD 14 to 21    */
    BSP_SETTING_IOMUX4_CR, /* BNK2 SDV PAD 22 to 29    */
    BSP_SETTING_IOMUX5_CR, /* BNK2 PAD 30 to 37        */
    BSP_SETTING_IOMUX6_CR  /* Sets whether the MMC/SD Voltage select lines
                                 are inverted on entry to the IOMUX structure */
};

#ifdef BSP_SETTING_ALT_IOMUX1_CR
IOMUX_CONFIG   iomux_alt_config_values = {
    BSP_SETTING_ALT_IOMUX0_CR, /* Selects whether the peripheral is connected to
                                 the Fabric or IOMUX structure. */
    BSP_SETTING_ALT_IOMUX1_CR, /* BNK4 SDV PAD 0 to 7, each IO has 4 bits   */
    BSP_SETTING_ALT_IOMUX2_CR, /* BNK4 SDV PAD 8 to 13     */
    BSP_SETTING_ALT_IOMUX3_CR, /* BNK2 SDV PAD 14 to 21    */
    BSP_SETTING_ALT_IOMUX4_CR, /* BNK2 SDV PAD 22 to 29    */
    BSP_SETTING_ALT_IOMUX5_CR, /* BNK2 PAD 30 to 37        */
    BSP_SETTING_ALT_IOMUX6_CR  /* Sets whether the MMC/SD Voltage select lines
                                 are inverted on entry to the IOMUX structure */
};
#endif
...
MSSIO_BANK4_CONFIG mssio_bank4_io_config = {
    /* BSP_SETTING_mssio_bank4_io_cfg_0_cr
        ...
        persist == 0
        */
    BSP_SETTING_MSSIO_BANK4_IO_CFG_0_1_CR,
    BSP_SETTING_MSSIO_BANK4_IO_CFG_2_3_CR,
    BSP_SETTING_MSSIO_BANK4_IO_CFG_4_5_CR,
    BSP_SETTING_MSSIO_BANK4_IO_CFG_6_7_CR,
    BSP_SETTING_MSSIO_BANK4_IO_CFG_8_9_CR,
    BSP_SETTING_MSSIO_BANK4_IO_CFG_10_11_CR,
    BSP_SETTING_MSSIO_BANK4_IO_CFG_12_13_CR,
};
...
MSSIO_BANK4_CONFIG mssio_alt_bank4_io_config = {
    /* BSP_SETTING_mssio_bank4_io_cfg_0_cr
        ...
        persist == 0
        */
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_0_1_CR,
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_2_3_CR,
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_4_5_CR,
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_6_7_CR,
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_8_9_CR,
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_10_11_CR,
    BSP_SETTING_ALT_MSSIO_BANK4_IO_CFG_12_13_CR,
};
#endif
...
MSSIO_BANK2_CONFIG mssio_bank2_io_config = {
    /* BSP_SETTING_mssio_bank4_io_cfg_0_cr
        ...
        persist == 0
        */
    BSP_SETTING_MSSIO_BANK2_IO_CFG_0_1_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_2_3_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_4_5_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_6_7_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_8_9_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_10_11_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_12_13_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_14_15_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_16_17_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_18_19_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_20_21_CR,
    BSP_SETTING_MSSIO_BANK2_IO_CFG_22_23_CR
};
...
MSSIO_BANK2_CONFIG mssio_alt_bank2_io_config = {
    /* BSP_SETTING_mssio_bank4_io_cfg_0_cr
        ...
        persist == 0
        */
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_0_1_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_2_3_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_4_5_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_6_7_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_8_9_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_10_11_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_12_13_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_14_15_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_16_17_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_18_19_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_20_21_CR,
    BSP_SETTING_ALT_MSSIO_BANK2_IO_CFG_22_23_CR
};
#endif
...
void set_bank2_and_bank4_volts(MSSIO_CONFIG_OPTION config)
{
    ...
    switch(config)
    {
        ...
        SCB_REGS->MSSIO_BANK2_CFG_CR.MSSIO_BANK2_CFG_CR =\
                    (uint32_t)BSP_SETTING_MSSIO_BANK2_CFG_CR;
        SCB_REGS->MSSIO_BANK4_CFG_CR.MSSIO_BANK4_CFG_CR =\
                    (uint32_t)BSP_SETTING_MSSIO_BANK4_CFG_CR;
        break;

#ifdef BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS
...
uint8_t  mss_is_alternate_io_setting_sd(void)
{
    ...
    if ((BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS & (EMMC_CONFIGURED_MASK | SD_CONFIGURED_MASK)) == (EMMC_CONFIGURED_MASK | SD_CONFIGURED_MASK))
    {
        if ((BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS & DEFAULT_ON_START_MASK)!=DEFAULT_ON_START_MASK)
        {
            result = true;
        }
    }
...
{
    uint8_t result = false;
#ifdef BSP_SETTING_HEADER_GENERATOR_VERSION_MAJOR
    uint32_t header_ver = (BSP_SETTING_HEADER_GENERATOR_VERSION_MAJOR*100) + (BSP_SETTING_HEADER_GENERATOR_VERSION_MINOR*10) + BSP_SETTING_HEADER_GENERATOR_VERSION_PATCH;
    uint32_t xml_ver = (BSP_SETTING_XML_VERSION_MAJOR*100) + (BSP_SETTING_XML_VERSION_MINOR*10) + BSP_SETTING_XML_VERSION_PATCH;
...
uint8_t  mss_io_default_setting(void)
{
    ...
    {
#ifdef BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS
#if ((BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS & (SD_CONFIGURED_MASK | DEFAULT_ON_START_MASK)) == (SD_CONFIGURED_MASK | DEFAULT_ON_START_MASK))

    result = SD_MSSIO_CONFIGURATION;

#elif  ((BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS & (EMMC_CONFIGURED_MASK | DEFAULT_ON_START_MASK)) == (EMMC_CONFIGURED_MASK))
...
uint8_t switch_mssio_config(MSS_IO_OPTIONS option)
{
    ...
    switch(option)
    {
        case SD_MSSIO_CONFIGURATION:
            ...
            switch_demux_using_mmc_ip(SD_MSSIO_CONFIGURATION);
            break;
        ...
        case EMMC_MSSIO_CONFIGURATION:
            ...
            switch_demux_using_mmc_ip(EMMC_MSSIO_CONFIGURATION);
            break;
 ...
 * @return true/false
 */
__attribute__((weak)) uint8_t mmc_sd_emmc_demux_present(void)
{
    return (uint8_t) MMC_SD_EMMC_DEMUX_SELECT_PRESENT;
}
 ...
 */
__attribute__((weak)) uint32_t * mmc_sd_emmc_demux_address(void)
{
    return (uint32_t *)MMC_SD_EMMC_DEMUX_SELECT_ADDRESS;
}

/**
 * switch_demux_using_mmc_ip()
 ...
 * @return
 */
__attribute__((weak)) uint8_t switch_demux_using_mmc_ip(MSS_IO_OPTIONS option)
{
    uint8_t result = false;

    if (mmc_sd_emmc_demux_present() == true)
    {
        volatile uint32_t *reg_pt = mmc_sd_emmc_demux_address();
        switch(option)
        {
            case SD_MSSIO_CONFIGURATION:
