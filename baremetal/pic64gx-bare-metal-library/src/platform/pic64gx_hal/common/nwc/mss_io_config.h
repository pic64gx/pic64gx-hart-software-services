...
/*
 * fields of BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS
 * */
 ...
 * was 0x4F000000UL
 */
#ifndef MMC_SD_EMMC_DEMUX_SELECT_ADDRESS
#define MMC_SD_EMMC_DEMUX_SELECT_ADDRESS 0x4FFFFF00UL /*!< This is design
                                                            dependent */
#endif
#ifndef MMC_SD_EMMC_DEMUX_SELECT_PRESENT
#define MMC_SD_EMMC_DEMUX_SELECT_PRESENT true /*!< true/false This is design
                                                      dependent */
#endif
 ...
 */
uint8_t switch_demux_using_mmc_ip(MSS_IO_OPTIONS option);
 ...
 */
uint8_t mmc_sd_emmc_demux_present(void);

/***************************************************************************//**
  mmc_sd_emmc_demux_address()

  This function is used by the routine switch_demux_using_mmc_ip()
  @return returns the address of the sd_emmc_demux 
 ...
 */
uint32_t * mmc_sd_emmc_demux_address(void);
...
/***************************************************************************//**
  ...
  BSP_SETTING_GPIO_INTERRUPT_FAB_CR
