...
#ifndef SRC_PLATFORM_PIC64GX_HAL_NWC_MSS_SGMII_H_
#define SRC_PLATFORM_PIC64GX_HAL_NWC_MSS_SGMII_H_
...
#if !defined (BSP_SETTING_MIN_DLL_90_CODE_VALUE_INDICATING_TT_PART_REVB)
...
#endif /* SRC_PLATFORM_PIC64GX_HAL_NWC_MSS_SGMII_H_ */
