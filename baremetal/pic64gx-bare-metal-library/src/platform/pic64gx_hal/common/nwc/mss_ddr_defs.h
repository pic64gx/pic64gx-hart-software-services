...
#ifndef SRC_PLATFORM_PIC64GX_HAL_NWC_MSS_DDR_DEFS_H_
#define SRC_PLATFORM_PIC64GX_HAL_NWC_MSS_DDR_DEFS_H_
...
/* supported clk speeds, these values come from the MSS Configurator
   in the following define - BSP_SETTING_DDR_CLK                           */
...
#endif /* SRC_PLATFORM_PIC64GX_HAL_NWC_MSS_DDR_DEFS_H_ */
