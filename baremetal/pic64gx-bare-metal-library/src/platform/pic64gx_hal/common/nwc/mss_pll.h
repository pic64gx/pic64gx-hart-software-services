...
/*=========================================================================*//**
  @page PIC64GX MSS Clock Setup
  ==============================================================================
  Introduction
  ==============================================================================
  The PIC64GX Microprocessor subsystem (MSS) has three PLL's, the MSS, DDR
  and MSS SGMII's.
...
#if !defined (BSP_SETTING_MSS_CLOCK_CONFIG_CR_LOW)
/*Master clock config (00=/1 01=/2 10=/4 11=/8 ) */
#define BSP_SETTING_MSS_CLOCK_CONFIG_CR_LOW    0x0000003EUL
    /* DIVIDER_CPU                       [0:2]   RW value= 0x2 */
    /* DIVIDER_AXI                       [2:2]   RW value= 0x3 */
    /* DIVIDER_APB_AHB                   [4:2]   RW value= 0x3 */
#endif

#if !defined (BSP_SETTING_MSS_CLOCK_CONFIG_CR_MED)
/*Master clock config (00=/1 01=/2 10=/4 11=/8 ) */
#define BSP_SETTING_MSS_CLOCK_CONFIG_CR_MED    0x00000029UL
    /* DIVIDER_CPU                       [0:2]   RW value= 0x1 */
    /* DIVIDER_AXI                       [2:2]   RW value= 0x2 */
    /* DIVIDER_APB_AHB                   [4:2]   RW value= 0x2 */
#endif

#define MSS_CLOCK_CONFIG_CR_LOW ((BSP_SETTING_MSS_CLOCK_CONFIG_CR &\
        0xFFFFFFC0UL) | BSP_SETTING_MSS_CLOCK_CONFIG_CR_LOW)

#define MSS_CLOCK_CONFIG_CR_MED ((BSP_SETTING_MSS_CLOCK_CONFIG_CR &\
        0xFFFFFFC0UL) | BSP_SETTING_MSS_CLOCK_CONFIG_CR_MED)
