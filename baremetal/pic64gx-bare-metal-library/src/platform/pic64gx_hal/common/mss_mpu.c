 ...
 * @brief PIC64GX MSS MPU driver for configuring access regions for the
 * external masters.
 *
 */
...
const uint64_t    mpu_fic0_values[] = {
    BSP_SETTING_FIC0_MPU_CFG_PMP0,
    BSP_SETTING_FIC0_MPU_CFG_PMP1,
    BSP_SETTING_FIC0_MPU_CFG_PMP2,
    BSP_SETTING_FIC0_MPU_CFG_PMP3,
    BSP_SETTING_FIC0_MPU_CFG_PMP4,
    BSP_SETTING_FIC0_MPU_CFG_PMP5,
    BSP_SETTING_FIC0_MPU_CFG_PMP6,
    BSP_SETTING_FIC0_MPU_CFG_PMP7,
    BSP_SETTING_FIC0_MPU_CFG_PMP8,
    BSP_SETTING_FIC0_MPU_CFG_PMP9,
    BSP_SETTING_FIC0_MPU_CFG_PMP10,
    BSP_SETTING_FIC0_MPU_CFG_PMP11,
    BSP_SETTING_FIC0_MPU_CFG_PMP12,
    BSP_SETTING_FIC0_MPU_CFG_PMP13,
    BSP_SETTING_FIC0_MPU_CFG_PMP14,
    BSP_SETTING_FIC0_MPU_CFG_PMP15
};
...
const uint64_t    mpu_fic1_values[] = {
    BSP_SETTING_FIC1_MPU_CFG_PMP0,
    BSP_SETTING_FIC1_MPU_CFG_PMP1,
    BSP_SETTING_FIC1_MPU_CFG_PMP2,
    BSP_SETTING_FIC1_MPU_CFG_PMP3,
    BSP_SETTING_FIC1_MPU_CFG_PMP4,
    BSP_SETTING_FIC1_MPU_CFG_PMP5,
    BSP_SETTING_FIC1_MPU_CFG_PMP6,
    BSP_SETTING_FIC1_MPU_CFG_PMP7,
    BSP_SETTING_FIC1_MPU_CFG_PMP8,
    BSP_SETTING_FIC1_MPU_CFG_PMP9,
    BSP_SETTING_FIC1_MPU_CFG_PMP10,
    BSP_SETTING_FIC1_MPU_CFG_PMP11,
    BSP_SETTING_FIC1_MPU_CFG_PMP12,
    BSP_SETTING_FIC1_MPU_CFG_PMP13,
    BSP_SETTING_FIC1_MPU_CFG_PMP14,
    BSP_SETTING_FIC1_MPU_CFG_PMP15
};
...
const uint64_t    mpu_fic2_values[] = {
    BSP_SETTING_FIC2_MPU_CFG_PMP0,
    BSP_SETTING_FIC2_MPU_CFG_PMP1,
    BSP_SETTING_FIC2_MPU_CFG_PMP2,
    BSP_SETTING_FIC2_MPU_CFG_PMP3,
    BSP_SETTING_FIC2_MPU_CFG_PMP4,
    BSP_SETTING_FIC2_MPU_CFG_PMP5,
    BSP_SETTING_FIC2_MPU_CFG_PMP6,
    BSP_SETTING_FIC2_MPU_CFG_PMP7,
};
...
const uint64_t    mpu_crypto_values[] = {
    BSP_SETTING_CRYPTO_MPU_CFG_PMP0,
    BSP_SETTING_CRYPTO_MPU_CFG_PMP1,
    BSP_SETTING_CRYPTO_MPU_CFG_PMP2,
    BSP_SETTING_CRYPTO_MPU_CFG_PMP3,
};
...
const uint64_t    mpu_gem0_values[] = {
    BSP_SETTING_GEM0_MPU_CFG_PMP0,
    BSP_SETTING_GEM0_MPU_CFG_PMP1,
    BSP_SETTING_GEM0_MPU_CFG_PMP2,
    BSP_SETTING_GEM0_MPU_CFG_PMP3,
    BSP_SETTING_GEM0_MPU_CFG_PMP4,
    BSP_SETTING_GEM0_MPU_CFG_PMP5,
    BSP_SETTING_GEM0_MPU_CFG_PMP6,
    BSP_SETTING_GEM0_MPU_CFG_PMP7,
};
...
const uint64_t    mpu_gem1_values[] = {
    BSP_SETTING_GEM1_MPU_CFG_PMP0,
    BSP_SETTING_GEM1_MPU_CFG_PMP1,
    BSP_SETTING_GEM1_MPU_CFG_PMP2,
    BSP_SETTING_GEM1_MPU_CFG_PMP3,
    BSP_SETTING_GEM1_MPU_CFG_PMP4,
    BSP_SETTING_GEM1_MPU_CFG_PMP5,
    BSP_SETTING_GEM1_MPU_CFG_PMP6,
    BSP_SETTING_GEM1_MPU_CFG_PMP7,
};
...
const uint64_t    mpu_mmc_values[] = {
    BSP_SETTING_MMC_MPU_CFG_PMP0,
    BSP_SETTING_MMC_MPU_CFG_PMP1,
    BSP_SETTING_MMC_MPU_CFG_PMP2,
    BSP_SETTING_MMC_MPU_CFG_PMP3,
};
...
const uint64_t    mpu_scb_values[] = {
    BSP_SETTING_SCB_MPU_CFG_PMP0,
    BSP_SETTING_SCB_MPU_CFG_PMP1,
    BSP_SETTING_SCB_MPU_CFG_PMP2,
    BSP_SETTING_SCB_MPU_CFG_PMP3,
    BSP_SETTING_SCB_MPU_CFG_PMP4,
    BSP_SETTING_SCB_MPU_CFG_PMP5,
    BSP_SETTING_SCB_MPU_CFG_PMP6,
    BSP_SETTING_SCB_MPU_CFG_PMP7,
};
...
const uint64_t    mpu_usb_values[] = {
    BSP_SETTING_USB_MPU_CFG_PMP0,
    BSP_SETTING_USB_MPU_CFG_PMP1,
    BSP_SETTING_USB_MPU_CFG_PMP2,
    BSP_SETTING_USB_MPU_CFG_PMP3,
};
...
const uint64_t    mpu_trace_values[] = {
    BSP_SETTING_TRACE_MPU_CFG_PMP0,
    BSP_SETTING_TRACE_MPU_CFG_PMP1,
};
