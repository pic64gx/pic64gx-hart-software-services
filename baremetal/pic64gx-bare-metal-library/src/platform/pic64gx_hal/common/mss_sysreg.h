...
/**************************************************************************
    *
 * @file mss_sysreg.h
 * @author Microchip Technolgy Inc
...
/*Indicates the device status in particular the state of the Coreplex IO banks*/
...
#define SOFT_RESET_CR_OFFSET                                     0x88
    ...
    /* */
    #define SOFT_RESET_CR_COREPLEX_OFFSET                            0x11
    #define SOFT_RESET_CR_COREPLEX_MASK                              (0x01 << 0x11)
    /* */
...
#define GPIO_CR_OFFSET                                           0x9C
    ...
    set or the the MSS_GPIO_RESET_N signal from the Coreplex. The allowed va
    lues are:* 0: Selects  MSS_GPIO_RESET_N signal from the Coreplex.* 1
...
#define MAINTENANCE_INTEN_CR_OFFSET                              0x140
    ...
    /* Enables interrupt when Coreplex turned on*/
    #define MAINTENANCE_INTEN_CR_COREPLEX_ON_OFFSET                  0x7
    #define MAINTENANCE_INTEN_CR_COREPLEX_ON_MASK                    (0x01 << 0x7)
    /* Enables interrupt when Coreplex turned off*/
    #define MAINTENANCE_INTEN_CR_COREPLEX_OFF_OFFSET                 0x8
    #define MAINTENANCE_INTEN_CR_COREPLEX_OFF_MASK                   (0x01 << 0x8)
...
#define MAINTENANCE_INT_SR_OFFSET                                0x148
    ...
    /* Indicates that the coreplex has been turned on cleared by writing
    a '1'*/
    #define MAINTENANCE_INT_SR_COREPLEX_ON_OFFSET                    0x7
    #define MAINTENANCE_INT_SR_COREPLEX_ON_MASK                      (0x01 << 0x7)
    /* Indicates that the coreplex array has been turned off cleared by writing
     a '1'*/
    #define MAINTENANCE_INT_SR_COREPLEX_OFF_OFFSET                   0x8
    #define MAINTENANCE_INT_SR_COREPLEX_OFF_MASK                     (0x01 << 0x8)
...
typedef struct _mss_sysreg
{
    ...
    /*Indicates the device status in particular the state of the MSS IO banks*/
