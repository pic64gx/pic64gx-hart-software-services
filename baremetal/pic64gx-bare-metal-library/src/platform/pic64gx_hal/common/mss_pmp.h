...
#define BSP_SETTING_MEM_CONFIGS_ENABLED      0ULL
...
/*
 * Bit offsets associated with BSP_SETTING_CONTEXT_A_HART_EN and
 * BSP_SETTING_CONTEXT_B_HART_EN
 */
...
/*
 * Bit offsets associated with BSP_SETTING_CONTEXT_A_FIC_EN and
 * BSP_SETTING_CONTEXT_B_FIC_EN
 */
