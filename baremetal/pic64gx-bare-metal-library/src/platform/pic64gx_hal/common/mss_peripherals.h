 ...
 * @brief PIC64GX MSS fumnctions related to MSS peripherals.
 *
 */
...
#if !defined (BSP_SETTING_CONTEXT_A_EN)
#define BSP_SETTING_CONTEXT_A_EN         0x00000000UL
#endif
#if !defined (BSP_SETTING_CONTEXT_B_EN)
#define BSP_SETTING_CONTEXT_B_EN         0x00000000UL
#endif
#if !defined (BSP_SETTING_CONTEXT_A_EN_FIC)
#define BSP_SETTING_CONTEXT_A_EN_FIC     0x0000000FUL
#endif
#if !defined (BSP_SETTING_CONTEXT_B_EN_FIC)
#define BSP_SETTING_CONTEXT_B_EN_FIC     0x0000000FUL
#endif
...
#ifndef BSP_SETTING_TURN_OFF_RAM_IF_NOT_USED
#define BSP_SETTING_TURN_OFF_RAM_IF_NOT_USED
#endif

#ifndef BSP_SETTING_CONFIGURED_PERIPHERALS
#define BSP_SETTING_CONFIGURED_PERIPHERALS 0xFFFFFFFF
#endif

#define CAN0_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_CONFIGURED_PERIPHERALS\
        & (1U<<15U))==0U) (SYSREG->RAM_SHUTDOWN_CR |= (1U <<0U))
#define CAN1_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_CONFIGURED_PERIPHERALS\
        & (1U<<16U))==0U) (SYSREG->RAM_SHUTDOWN_CR |= (1U <<1U))
#define USB_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_CONFIGURED_PERIPHERALS\
        & (1U<<2U))==0U) (SYSREG->RAM_SHUTDOWN_CR |= (1U <<2U))
#define MAC0_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_CONFIGURED_PERIPHERALS\
        & (1U<<3U))==0U) (SYSREG->RAM_SHUTDOWN_CR |= (1U<<3U))
#define MAC1_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_CONFIGURED_PERIPHERALS\
        & (1U<<4U))==0U) (SYSREG->RAM_SHUTDOWN_CR |= (1U<<4U))
#define MMC_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_CONFIGURED_PERIPHERALS\
        & (3U<<0U))==0U) (SYSREG->RAM_SHUTDOWN_CR |= (1U<<5U))
#define DDR_RAM_OFF_IF_NOT_CONFIGURED() if((BSP_SETTING_DDRPHY_MODE &\
...
/***************************************************************************//**
  This function is used to turn on the coreplex enable
...
/***************************************************************************//**
  ...
  Example:
  @code
    mss_disable_coreplex();
  @endcode
 */
void mss_disable_coreplex(void);
...
/***************************************************************************//**
  ...
  BSP_SETTING_APBBUS_CR

  Example:
  @code
    mss_set_apb_bus_cr(BSP_SETTING_APBBUS_CR);
  @endcode
 */
