 ...
 *
 * This file contains type definitions used throughout the PIC64GX MSS
...
/*******************************************************************************
  PIC64GX MSS Ethernet MAC Configuration Structure.
  The mss_mac_cfg_t type contains the initial configuration values for the PIC64GX
  ...
  interface_type
    ...
    currently supported values are:
      ...
      NULL_PHY   - No PHY involved, usually for direct connection
      GMII       - Connection via GMII routed to external PHY device.
