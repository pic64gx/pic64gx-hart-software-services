 ...
 *
 * Register bit offsets and masks definitions for PIC64GX MSS MMUART
 *
 */
/*-------------------------------------------------------------------------*//**
  @page
  ...
  ==============================================================================
    ...
    project in the following order to allow over-ride of user settings.
     - coreplex_ihc_defines.h
     - coreplex_ihc_config.h  we can over-ride default setting in this file
                         This config file is stored in the boards directory and
                         is called from the coreplex_sw_config.h file.
     - coreplex_ihc_regs.h
     - coreplex_ihc.h
...
/***************************************************************************//**
  ...
  coreplex_ihc_add_mapping.h file which is populated with base addresses from the
