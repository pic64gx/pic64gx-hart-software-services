 ...
 *
 * PIC64GX Microprocessor Subsystem Inter-Hart Communication bare metal
 * software driver implementation.
 *
 */
#include "pic64gx_hal/mss_hal.h"
#include "coreplex_ihc.h"
 ...
 * IHC_global_init()
 *
 * See coreplex_ihc.h for details of how to use this
 * function.
 */
 ...
 *
 * See coreplex_ihc.h or coreplex_ihc user guide for details of how to use this
 * function.
 */
