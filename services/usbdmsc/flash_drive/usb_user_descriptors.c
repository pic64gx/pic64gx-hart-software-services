 ...
 * PIC64GX Coreplex USB operations in USB Device mode.
 *
...
#include "drivers/coreplex/coreplex_usb/coreplex_usb_std_def.h"
...
#define  USB_STRING_PRODUCT                                 "PIC64GX-FlashDrive"
