 ...
 * PIC64GX Coreplex USB operations in device mode.
 *
 * Drivers used:
 * PIC64GX Coreplex USB Driver stack (inclusive of USBD-MSC class driver).
...
// undefine OPENSBI as we want to use PIC64GX_HAL types in this module
#undef CONFIG_OPENSBI
#include "mss_plic.h"
#include "mss_clint.h"
#include <stdbool.h>
#include "flash_drive_app.h"
#include "drivers/coreplex/coreplex_usb/coreplex_usb_device.h"
#include "drivers/coreplex/coreplex_usb/coreplex_usb_device_msd.h"
#include "hal/hal.h"
#include "mss_hal.h"
#include "mss_mpu.h"
