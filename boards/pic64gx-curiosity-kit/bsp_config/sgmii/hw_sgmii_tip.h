...
#if !defined (BSP_SETTING_SGMII_MODE)
/*SGMII mode control (SEU) */
#define BSP_SETTING_SGMII_MODE    0x08C0F2FFUL
...
#endif
#if !defined (BSP_SETTING_PLL_CNTL)
/*PLL control register (SEU) */
#define BSP_SETTING_PLL_CNTL    0x80140101UL
...
#endif
#if !defined (BSP_SETTING_CH0_CNTL)
/*Channel0 control register */
#define BSP_SETTING_CH0_CNTL    0x37F07770UL
...
#endif
#if !defined (BSP_SETTING_CH1_CNTL)
/*Channel1 control register */
#define BSP_SETTING_CH1_CNTL    0x37F07770UL
...
#endif
#if !defined (BSP_SETTING_RECAL_CNTL)
/*Recalibration control register */
#define BSP_SETTING_RECAL_CNTL    0x000020C8UL
...
#endif
#if !defined (BSP_SETTING_CLK_CNTL)
/*Clock input and routing control registers */
#define BSP_SETTING_CLK_CNTL    0xF00050CCUL
...
#endif
#if !defined (BSP_SETTING_DYN_CNTL)
/*Dynamic control registers */
#define BSP_SETTING_DYN_CNTL    0x00000000UL
...
#endif
#if !defined (BSP_SETTING_PVT_STAT)
/*PVT calibrator status registers */
#define BSP_SETTING_PVT_STAT    0x00000000UL
...
#endif
#if !defined (BSP_SETTING_SPARE_CNTL)
/*Spare control register */
#define BSP_SETTING_SPARE_CNTL    0xFF000000UL
    /* REG_SPARE                         [0:32]  RW value= 0xFF000000 */
#endif
#if !defined (BSP_SETTING_SPARE_STAT)
/*Spare status register */
#define BSP_SETTING_SPARE_STAT    0x00000000UL
    /* SRO_SPARE                         [0:32]  RO */
#endif
