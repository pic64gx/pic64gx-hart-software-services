...
#if !defined (BSP_SETTING_APB_SPLIT_VERSION)
/*This version incrments when change to format of this file */
#define BSP_SETTING_APB_SPLIT_VERSION    0x00000001UL
    /* VERSION                           [0:32]  RW value= 0x1 */
#endif
#if !defined (BSP_SETTING_MEM_CONFIGS_ENABLED)
/*Enabled in configurator when bit set to 1 */
#define BSP_SETTING_MEM_CONFIGS_ENABLED    0x00000000UL
    /* PMP                               [0:0]   RW value= 0x0 */
    /* MPU                               [1:0]   RW value= 0x0 */
#endif
#if !defined (BSP_SETTING_APBBUS_CR)
...
#define BSP_SETTING_APBBUS_CR    0x00000000UL
...
#define BSP_SETTING_CONTEXT_B_EN    0x00000000UL
    ...
    /* EMMC                              [30:1]  RW value= 0x0 */
#endif
#if !defined (BSP_SETTING_CONTEXT_A_HART_EN)
/*When the register bit is '0' hart is not associated with context A. */
#define BSP_SETTING_CONTEXT_A_HART_EN    0x00000000UL
...
#endif
#if !defined (BSP_SETTING_CONTEXT_B_HART_EN)
/*When the register bit is '0' hart is not associated with context B. */
#define BSP_SETTING_CONTEXT_B_HART_EN    0x00000000UL
    /* HART0                             [0:1]   RW value= 0x0 */
    /* HART1                             [1:1]   RW value= 0x0 */
    /* HART2                             [2:1]   RW value= 0x0 */
    /* HART3                             [3:1]   RW value= 0x0 */
