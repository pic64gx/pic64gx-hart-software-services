...
#endif
#if !defined (BSP_SETTING_IOMUX1_CR)
...
#define BSP_SETTING_IOMUX1_CR    0x00000000UL
...
#endif
#if !defined (BSP_SETTING_IOMUX2_CR)
/*Configures the IO Mux structure for each IO pad. 0 implies SD/SDIO, 1 implies
EMMC, 2 implies QSPI, 3 implies SPI,4 implies USB,5 implies MMUART,6 implies
I2C,7 implies CAN,8 implies MDIO,9 implies Miscellaneous,0xA implies Reserved
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define BSP_SETTING_IOMUX2_CR    0x00BB0000UL
...
#endif
#if !defined (BSP_SETTING_IOMUX3_CR)
/*Configures the IO Mux structure for each IO pad. 0 implies SD/SDIO, 1 implies
EMMC, 2 implies QSPI, 3 implies SPI,4 implies USB,5 implies MMUART,6 implies
I2C,7 implies CAN,8 implies MDIO,9 implies Miscellaneous,0xA implies Reserved
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define BSP_SETTING_IOMUX3_CR    0xBBBBBBBBUL
    /* PAD14                             [0:4]   RW value= 0xB */
    /* PAD15                             [4:4]   RW value= 0xB */
    /* PAD16                             [8:4]   RW value= 0xB */
    /* PAD17                             [12:4]  RW value= 0xB */
    /* PAD18                             [16:4]  RW value= 0xB */
    /* PAD19                             [20:4]  RW value= 0xB */
    /* PAD20                             [24:4]  RW value= 0xB */
    /* PAD21                             [28:4]  RW value= 0xB */
#endif
#if !defined (BSP_SETTING_IOMUX4_CR)
/*Configures the IO Mux structure for each IO pad. 0 implies SD/SDIO, 1 implies
EMMC, 2 implies QSPI, 3 implies SPI,4 implies USB,5 implies MMUART,6 implies
I2C,7 implies CAN,8 implies MDIO,9 implies Miscellaneous,0xA implies Reserved
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define BSP_SETTING_IOMUX4_CR    0x5566BBBBUL
    /* PAD22                             [0:4]   RW value= 0xB */
    /* PAD23                             [4:4]   RW value= 0xB */
    /* PAD24                             [8:4]   RW value= 0xB */
    /* PAD25                             [12:4]  RW value= 0xB */
    /* PAD26                             [16:4]  RW value= 0x6 */
    /* PAD27                             [20:4]  RW value= 0x6 */
    /* PAD28                             [24:4]  RW value= 0x5 */
    /* PAD29                             [28:4]  RW value= 0x5 */
#endif
#if !defined (BSP_SETTING_IOMUX5_CR)
/*Configures the IO Mux structure for each IO pad. 0 implies SD/SDIO, 1 implies
EMMC, 2 implies QSPI, 3 implies SPI,4 implies USB,5 implies MMUART,6 implies
I2C,7 implies CAN,8 implies MDIO,9 implies Miscellaneous,0xA implies Reserved
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define BSP_SETTING_IOMUX5_CR    0xB66B3333UL
...
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_CFG_CR)
/*Configures the MSSIO block using SCB write */
#define BSP_SETTING_MSSIO_BANK4_CFG_CR    0x00040A0DUL
...
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_0_1_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_0_1_CR    0x09300930UL
    /* IO_CFG_0                          [0:16]  RW value= 0x0930 */
    /* IO_CFG_1                          [16:16] RW value= 0x0930 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_2_3_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_2_3_CR    0x09300930UL
    /* IO_CFG_2                          [0:16]  RW value= 0x0930 */
    /* IO_CFG_3                          [16:16] RW value= 0x0930 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_4_5_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_4_5_CR    0x09300930UL
    /* IO_CFG_4                          [0:16]  RW value= 0x0930 */
    /* IO_CFG_5                          [16:16] RW value= 0x0930 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_6_7_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_6_7_CR    0x09300928UL
    /* IO_CFG_6                          [0:16]  RW value= 0x0928 */
    /* IO_CFG_7                          [16:16] RW value= 0x0930 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_8_9_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_8_9_CR    0x09300930UL
    /* IO_CFG_8                          [0:16]  RW value= 0x0930 */
    /* IO_CFG_9                          [16:16] RW value= 0x0930 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_10_11_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_10_11_CR    0x09300930UL
    /* IO_CFG_10                         [0:16]  RW value= 0x0930 */
    /* IO_CFG_11                         [16:16] RW value= 0x0930 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK4_IO_CFG_12_13_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK4_IO_CFG_12_13_CR    0x09280928UL
    /* IO_CFG_12                         [0:16]  RW value= 0x0928 */
    /* IO_CFG_13                         [16:16] RW value= 0x0928 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_CFG_CR)
/*Configures the MSSIO block using SCB write */
#define BSP_SETTING_MSSIO_BANK2_CFG_CR    0x00080907UL
    ...
    /* RESERVED2                         [20:12] RW value= 0x0 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_0_1_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_0_1_CR    0x00610061UL
    /* IO_CFG_0                          [0:16]  RW value= 0x0061 */
    /* IO_CFG_1                          [16:16] RW value= 0x0061 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_2_3_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_2_3_CR    0x00610061UL
    /* IO_CFG_2                          [0:16]  RW value= 0x0061 */
    /* IO_CFG_3                          [16:16] RW value= 0x0061 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_4_5_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_4_5_CR    0x00610061UL
    /* IO_CFG_4                          [0:16]  RW value= 0x0061 */
    /* IO_CFG_5                          [16:16] RW value= 0x0061 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_6_7_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_6_7_CR    0x00610061UL
    /* IO_CFG_6                          [0:16]  RW value= 0x0061 */
    /* IO_CFG_7                          [16:16] RW value= 0x0061 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_8_9_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_8_9_CR    0x00610061UL
    /* IO_CFG_8                          [0:16]  RW value= 0x0061 */
    /* IO_CFG_9                          [16:16] RW value= 0x0061 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_10_11_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_10_11_CR    0x00610061UL
    /* IO_CFG_10                         [0:16]  RW value= 0x0061 */
    /* IO_CFG_11                         [16:16] RW value= 0x0061 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_12_13_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_12_13_CR    0x08290829UL
    /* IO_CFG_12                         [0:16]  RW value= 0x0829 */
    /* IO_CFG_13                         [16:16] RW value= 0x0829 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_14_15_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_14_15_CR    0x08290829UL
    /* IO_CFG_14                         [0:16]  RW value= 0x0829 */
    /* IO_CFG_15                         [16:16] RW value= 0x0829 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_16_17_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_16_17_CR    0x08290429UL
    /* IO_CFG_16                         [0:16]  RW value= 0x0429 */
    /* IO_CFG_17                         [16:16] RW value= 0x0829 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_18_19_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_18_19_CR    0x08290829UL
    /* IO_CFG_18                         [0:16]  RW value= 0x0829 */
    /* IO_CFG_19                         [16:16] RW value= 0x0829 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_20_21_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_20_21_CR    0x08290829UL
    /* IO_CFG_20                         [0:16]  RW value= 0x0829 */
    /* IO_CFG_21                         [16:16] RW value= 0x0829 */
#endif
#if !defined (BSP_SETTING_MSSIO_BANK2_IO_CFG_22_23_CR)
/*IO electrical configuration for MSSIO pad */
#define BSP_SETTING_MSSIO_BANK2_IO_CFG_22_23_CR    0x08290829UL
    /* IO_CFG_22                         [0:16]  RW value= 0x0829 */
    /* IO_CFG_23                         [16:16] RW value= 0x0829 */
#endif
#if !defined (BSP_SETTING_MSSIO_VB2_CFG)
/*default dpc values for MSSIO bank 2 */
#define BSP_SETTING_MSSIO_VB2_CFG    0x00000828UL
    ...
    /* RESERVED                          [15:17] R */
#endif
#if !defined (BSP_SETTING_MSSIO_VB4_CFG)
/*default dpc values for MSSIO bank 4 */
#define BSP_SETTING_MSSIO_VB4_CFG    0x00000828UL
    /* DPC_IO_CFG_IBUFMD_0               [0:1]   RW value= 0x0 */
    /* DPC_IO_CFG_IBUFMD_1               [1:1]   RW value= 0x0 */
    /* DPC_IO_CFG_IBUFMD_2               [2:1]   RW value= 0x0 */
    /* DPC_IO_CFG_DRV_0                  [3:1]   RW value= 0x1 */
    ...
    /* RESERVED                          [15:17] R */
#endif
#if !defined (BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS)
...
#define BSP_SETTING_MSSIO_CONFIGURATION_OPTIONS    0x00000006UL
    /* EMMC_CONFIGURED                   [0:1]   RW value= 0x0 */
    /* SD_CONFIGURED                     [1:1]   RW value= 0x1 */
    /* DEFAULT_ON_START                  [2:1]   RW value= 0x1 */
#endif
#if !defined (BSP_SETTING_GPIO_INTERRUPT_FAB_CR)
...
#define BSP_SETTING_GPIO_INTERRUPT_FAB_CR    0x00000000UL
