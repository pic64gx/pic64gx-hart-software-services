...
#if !defined (BSP_SETTING_SGMII_SOFT_RESET)
...
#define BSP_SETTING_SGMII_SOFT_RESET    0x00000000UL
    /* NV_MAP                            [0:1]   RST */
    /* V_MAP                             [1:1]   RST */
    /* PERIPH                            [8:1]   RST */
    /* BLOCKID                           [16:16] ID */
#endif
#if !defined (BSP_SETTING_SGMII_PLL_CTRL)
/*PLL control register */
#define BSP_SETTING_SGMII_PLL_CTRL    0x0100003FUL
    ...
    /* LOCK_B                            [31:1]  RO */
#endif
#if !defined (BSP_SETTING_SGMII_PLL_REF_FB)
/*PLL reference and feedback registers */
#define BSP_SETTING_SGMII_PLL_REF_FB    0x00000100UL
    ...
    /* RESERVE15                         [28:4]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_PLL_FRACN)
/*PLL fractional register */
#define BSP_SETTING_SGMII_PLL_FRACN    0x00000000UL
    /* FRACN_EN                          [0:1]   RW value= 0x0 */
    /* FRACN_DAC_EN                      [1:1]   RW value= 0x0 */
    /* RESERVE16                         [2:6]   RSVD */
    /* RESERVE17                         [8:24]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_PLL_DIV_0_1)
/*PLL 0/1 division registers */
#define BSP_SETTING_SGMII_PLL_DIV_0_1    0x01000100UL
    /* VCO0PH_SEL                        [0:3]   RO */
    ...
    /* RESERVE21                         [31:1]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_PLL_DIV_2_3)
/*PLL 2/3 division registers */
#define BSP_SETTING_SGMII_PLL_DIV_2_3    0x01000100UL
    /* VCO2PH_SEL                        [0:3]   RO */
...
#endif
#if !defined (BSP_SETTING_SGMII_PLL_CTRL2)
/*PLL control register */
#define BSP_SETTING_SGMII_PLL_CTRL2    0x00001020UL
...
#endif
#if !defined (BSP_SETTING_SGMII_PLL_CAL)
/*PLL calibration register */
#define BSP_SETTING_SGMII_PLL_CAL    0x00000D06UL
    ...
    /* RESERVE30                         [23:9]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_PLL_PHADJ)
/*PLL phase registers */
#define BSP_SETTING_SGMII_PLL_PHADJ    0x00007443UL
...
#endif
#if !defined (BSP_SETTING_SGMII_SSCG_REG_0)
/*SSCG registers 0 */
#define BSP_SETTING_SGMII_SSCG_REG_0    0x00000000UL
    /* DIVVAL                            [0:6]   RW value= 0x0 */
    /* FRACIN                            [6:24]  RW value= 0x0 */
    /* RESERVE00                         [30:2]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_SSCG_REG_1)
/*SSCG registers 1 */
#define BSP_SETTING_SGMII_SSCG_REG_1    0x00000000UL
    /* DOWNSPREAD                        [0:1]   RW value= 0x0 */
    /* SSMD                              [1:5]   RW value= 0x0 */
    /* FRACMOD                           [6:24]  RO */
    /* RESERVE01                         [30:2]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_SSCG_REG_2)
/*SSCG registers 2 */
#define BSP_SETTING_SGMII_SSCG_REG_2    0x00000014UL
    /* INTIN                             [0:12]  RW value= 0x14 */
    /* INTMOD                            [12:12] RO */
    /* RESERVE02                         [24:8]  RSVD */
#endif
#if !defined (BSP_SETTING_SGMII_SSCG_REG_3)
/*SSCG registers 3 */
#define BSP_SETTING_SGMII_SSCG_REG_3    0x00000001UL
