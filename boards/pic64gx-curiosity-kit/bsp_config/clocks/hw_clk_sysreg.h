...
#if !defined (BSP_SETTING_MSS_SYSREG_CLKS_VERSION)
/*This version incrments when change to format of this file */
#define BSP_SETTING_MSS_SYSREG_CLKS_VERSION    0x00000001UL
    /* VERSION                           [0:32]  RW value= 0x1 */
#endif
#if !defined (BSP_SETTING_MSS_CLOCK_CONFIG_CR)
/*Master clock config (00=/1 01=/2 10=/4 11=/8 ) */
#define BSP_SETTING_MSS_CLOCK_CONFIG_CR    0x00000024UL
...
#endif
#if !defined (BSP_SETTING_MSS_RTC_CLOCK_CR)
/*RTC clock divider */
#define BSP_SETTING_MSS_RTC_CLOCK_CR    0x0000007DUL
    /* PERIOD                            [0:12]  RW value= 0x7D */
#endif
#if !defined (BSP_SETTING_MSS_ENVM_CR)
...
#define BSP_SETTING_MSS_ENVM_CR    0x40050005UL
